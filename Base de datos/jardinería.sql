...
-- Volcando datos para la tabla jardineria.cliente: ~35 rows (aproximadamente)
DELETE FROM `cliente`;
...
-- Volcando estructura para tabla jardineria.factura
CREATE TABLE IF NOT EXISTS `factura` (
  ...
  CONSTRAINT `idCliente` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`codigo_cliente`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla jardineria.factura: ~0 rows (aproximadamente)
DELETE FROM `factura`;
/*!40000 ALTER TABLE `factura` DISABLE KEYS */;
INSERT INTO `factura` (`idFactura`, `idCliente`, `total`) VALUES
	(11, 5, 0),
	(12, 6, 5);
...
INSERT INTO `producto` (`codigo_producto`, `nombre`, `gama`, `dimensiones`, `proveedor`, `descripcion`, `cantidad_en_stock`, `precio_venta`, `precio_proveedor`) VALUES
	('000aaa', 'Petunia', 'Aromáticas', NULL, 'Carlitos', '5', 15, 6.00, 3.00),
	...
	('aaaa100', 'Flores de Lavanda', 'Aromáticas', NULL, 'Casa Floral', ' 100', 100, 2.00, 1.00),
